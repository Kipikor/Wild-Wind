...
| R1T | Тендер | 10 т | 400 кВт | 3 | Служебная поддержка катеров: ремонт, фургон, кран, снабжение. |
| R2 | Корвет | 25 т | 900 кВт | 6 | Первый самостоятельный малый корабль с экипажем и несколькими отсеками. |
| R3 | Фрегат | 60 т | 2,5 МВт | 15 | Автономная рабочая единица для островной экономики. |
| R4 | Эсминец | 180 т | 7 МВт | 40 | Военный/промышленный корабль с несколькими подсистемами. |
| R5 | Крейсер | 600 т | 20 МВт | 120 | Региональный корабль, который сам создает сервис вокруг себя. |
| R6 | Линкор | 2000 т | 60 МВт | 350 | Тяжелый корабль флота, требует постоянной логистики и сервиса. |
| R7 | Капитал | 6000 т | 180 МВт | 1000 | Летающая инфраструктура: док, порт, сервисный узел или флотский центр. |

Эти числа - средние якоря для баланса, не диапазоны. Катера уже заведены в данных как одноместные R1-машины; тендер - служебный промежуточный класс внутри ранней промышленной экономики. Текущие тендеры: Опора как ремонтно-крановая поддержка и Топливщик как перевозчик только угля и клавдия.
